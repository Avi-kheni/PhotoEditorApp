...
//        adjustsWidthToFillItsContens(self)
    ...
    private func setup() {
        ...
        self.closeView?.tintColor = .red
        self.rotateView?.tintColor = .black
...
extension JLStickerLabelView {
    ...
    private func setupCloseAndRotateView() {
        ...
        rotateView = UIImageView(frame: CGRect(x:( self.bounds.size.width + 10) - globalInset! * 2, y: self.bounds.size.height - globalInset! * 2, width: globalInset! * 2 - 10, height: globalInset! * 2 - 10))
